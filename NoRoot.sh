#!/system/xbin/bash
#AUTHOR:./Ip-Address404
#Github:https://github.com/Ip-Address404
...
╔════════════════════════════════════════════════════════════╗
║                                                            ║
║*AUTHOR=./Ip_Address.404                                    ║
║                                                            ║
║*Fb=https:https://www.facebook.com/100045683043717          ║
║                                                            ║
║*Team=Hacker Indonesia_Team                                 ║
║                                                            ║
║*Email=saputra230622@gmail.com                              ║
║                                                            ║
╚════════════════════════════════════════════════════════════╝
"
sleep 3

echo "\033[32;1mTULIS= Saputra-Tamvanx "
read p;
...
sleep 4
echo "Hubungi Gua saputra230622@gmail.com"
sleep 3
